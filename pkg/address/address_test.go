...
func TestFromMnemonic(t *testing.T) {
	...
	tests := []struct {
		...
		{"valid mnemonic index 0", mnemonic, "", 0, false},
		{"valid mnemonic index 1", mnemonic, "", 1, false},
		{"valid mnemonic index 2", mnemonic, "", 2, false},
		{"with passphrase", mnemonic, "test", 0, false},
		{"empty mnemonic", "", "", 0, true},
		{"invalid mnemonic", "invalid words", "", 0, true},
	}
